...
def calcula_frecuencias_dia(dia_entrante):  
    #######################################
    ...
    ##############################################################################################
    if (dia_entrante=="Sábado"):
        matriz_dia=matriz_sabados
    if (dia_entrante=="Miércoles"):
    ...
    #####################################################################################
    if (dia_entrante=="Sábado"):
        nombre_archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/resultados_solo_sabados.csv"
    if (dia_entrante=="Miércoles"):
        nombre_archivo="C:/Users/Luciano/Django_curso/proyectosdjango/ProyectoLoteria/AppDia/programas/resultados/resultados_solo_miercoles.csv"   
